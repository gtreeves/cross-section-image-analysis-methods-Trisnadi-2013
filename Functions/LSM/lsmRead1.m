function s = lsmRead1(varargin)
%Ftn to read in one slice from a z-stack in lsm fmt, from tiffread ver 2.5
%
%function s = lsmRead1(varargin)
%
% This function differs from "lsmReadDU" because it is capable of
% constructing an output with an arbitrary number of color channels.  It is
% different from lsmRead2, which reads in the whole z-stack at once.  The
% utility of this function is you can read in only a part of the z-stack so
% it doesn't take as long or use as much RAM.
%
